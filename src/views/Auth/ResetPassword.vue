          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card shadow-lg border-0">
              <div class="card-body p-4">
                ...
                <p class="text-center mb-4">Digite sua nova senha , não esqueça que ela deve ter mais de 8 digitos</p>
                <form>
                  ...
                  <div data-mdb-input-init class="form-outline mb-4 mt-5">
                    <label class="form-label" for="form3Example1">Confirme o seu email</label>
                    <input type="email" id="form3Example1" class="form-control" />
                  </div>
                  <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4">Redefinir senha!</button>
